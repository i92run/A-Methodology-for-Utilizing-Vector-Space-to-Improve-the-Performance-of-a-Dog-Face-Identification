...
class online_adaptive_hard_image_generators:
    ...
    def online_adaptive_hard_image_generator(self,
        ...
        while True:
            ...
            f_triplet_hard, y_triplet_hard, predict_hard = define_adaptive_hard_triplets_batch(subfilenames, sublabels, predict, self.nbof_hard_triplets*3, use_neg=True, use_pos=True)
            f_triplet_soft, y_triplet_soft, predict_soft = define_adaptive_hard_triplets_batch(subfilenames, sublabels, predict, batch_size-self.nbof_hard_triplets*3, use_neg=False, use_pos=False)
